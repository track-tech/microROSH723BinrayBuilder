...
void HAL_SPI_MspInit(SPI_HandleTypeDef* hspi)
{
  ...
  */
    ...
    PB15     ------> SPI2_MOSI
    */
    GPIO_InitStruct.Pin = PB13_SPI2_MCP2517FD2_SCK_Pin|PB14_SPI2_MCP2517FD2_MISO_Pin|PB15_SPI2_MCP2517FD2_MOSI_Pin;
  ...
  */
    ...
    PC12     ------> SPI3_MOSI
    */
    GPIO_InitStruct.Pin = PC10_SPI3_MCP2517FD2_SCK_Pin|PC11_SPI3_MCP2517FD2_MISO_Pin|PC12_SPI3_MCP2517FD2_MOSI_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
  ...
  else if(hspi->Instance==SPI4)
  {
    ...
    PE14     ------> SPI4_MOSI
    */
    GPIO_InitStruct.Pin = PE13_SPI4_MCP2517FD2_SCK_Pin|PE13_SPI4_MCP2517FD2_MISO_Pin|PE14_SPI4_MCP2517FD2_MOSI_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
  ...
  else if(hspi->Instance==SPI5)
  {
    ...
    PF9     ------> SPI5_MOSI
    */
    GPIO_InitStruct.Pin = PF7_SPI5_MCP2517FD4_SCK_Pin|PF8_SPI5_MCP2517FD4_MISO_Pin|PF9_SPI5_MCP2517FD4_MOSI_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
  ...
  else if(hspi->Instance==SPI6)
  {
    ...
    PA7     ------> SPI6_MOSI
    */
    GPIO_InitStruct.Pin = PA5_SPI6_W5100S_SCK_Pin|PA6_SPI6_W5100S_MISO_Pin|PA6_SPI6_W5100S_MOSI_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  if(hspi->Instance==SPI2)
  {
    ...
    PB15     ------> SPI2_MOSI
    */
    HAL_GPIO_DeInit(GPIOB, PB13_SPI2_MCP2517FD2_SCK_Pin|PB14_SPI2_MCP2517FD2_MISO_Pin|PB15_SPI2_MCP2517FD2_MOSI_Pin);
  ...
  else if(hspi->Instance==SPI3)
  {
    ...
    PC12     ------> SPI3_MOSI
    */
    HAL_GPIO_DeInit(GPIOC, PC10_SPI3_MCP2517FD2_SCK_Pin|PC11_SPI3_MCP2517FD2_MISO_Pin|PC12_SPI3_MCP2517FD2_MOSI_Pin);
  ...
  else if(hspi->Instance==SPI4)
  {
    ...
    PE14     ------> SPI4_MOSI
    */
    HAL_GPIO_DeInit(GPIOE, PE13_SPI4_MCP2517FD2_SCK_Pin|PE13_SPI4_MCP2517FD2_MISO_Pin|PE14_SPI4_MCP2517FD2_MOSI_Pin);
  ...
  else if(hspi->Instance==SPI5)
  {
    ...
    PF9     ------> SPI5_MOSI
    */
    HAL_GPIO_DeInit(GPIOF, PF7_SPI5_MCP2517FD4_SCK_Pin|PF8_SPI5_MCP2517FD4_MISO_Pin|PF9_SPI5_MCP2517FD4_MOSI_Pin);
  ...
  else if(hspi->Instance==SPI6)
  {
    ...
    PA7     ------> SPI6_MOSI
    */
    HAL_GPIO_DeInit(GPIOA, PA5_SPI6_W5100S_SCK_Pin|PA6_SPI6_W5100S_MISO_Pin|PA6_SPI6_W5100S_MOSI_Pin);
...
void HAL_UART_MspInit(UART_HandleTypeDef* huart)
{
  ...
  */
    ...
    PA10     ------> USART1_RX
    */
    GPIO_InitStruct.Pin = GPIO_PIN_9|PA10_R8SM_UART1_RX_SBUS_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
  ...
  */
    ...
    PD6     ------> USART2_RX
    */
    GPIO_InitStruct.Pin = PD5_USART2_TX_Pin|PD6_USART2_RX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
  ...
  */
    ...
    PG12     ------> USART10_TX
    */
    GPIO_InitStruct.Pin = PG11_USART10_RX_Pin|PG12_USART10_TX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  if(huart->Instance==USART1)
  {
    ...
    PA10     ------> USART1_RX
    */
    HAL_GPIO_DeInit(GPIOA, GPIO_PIN_9|PA10_R8SM_UART1_RX_SBUS_Pin);
  ...
  else if(huart->Instance==USART2)
  {
    ...
    PD6     ------> USART2_RX
    */
    HAL_GPIO_DeInit(GPIOD, PD5_USART2_TX_Pin|PD6_USART2_RX_Pin);
  ...
  else if(huart->Instance==USART10)
  {
    ...
    PG12     ------> USART10_TX
    */
    HAL_GPIO_DeInit(GPIOG, PG11_USART10_RX_Pin|PG12_USART10_TX_Pin);
